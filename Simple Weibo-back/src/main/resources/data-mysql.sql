...
INSERT IGNORE INTO `user` (`id`, `username`, `password`, `avatar`, `bio`, `followers`, `following`) VALUES
...
-- 插入测试微博
INSERT IGNORE INTO `post` (`id`, `content`, `author_id`, `images`, `likes`, `reposts`, `comments_count`, `views`, `created_at`) VALUES
...
-- 插入测试评论
INSERT IGNORE INTO `comment` (`id`, `post_id`, `content`, `author_id`, `created_at`) VALUES
